...
type Channel struct {
	...
	PermissionOverwrites []interface{} `json:"permission_overwrites" mapstructure:"permission_overwrites"`
	...
	Topic                interface{}   `json:"topic" mapstructure:"topic"`
	Bitrate              *int64        `json:"bitrate,omitempty" mapstructure:"bitrate"`
	RTCRegion            interface{}   `json:"rtc_region" mapstructure:"rtc_region"`
