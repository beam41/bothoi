...
type Guild struct {
	AfkChannelID                any              `json:"afk_channel_id" mapstructure:"afk_channel_id"`
	...
	ApplicationID               any              `json:"application_id" mapstructure:"application_id"`
	Banner                      any              `json:"banner" mapstructure:"banner"`
	...
	DiscoverySplash             any              `json:"discovery_splash" mapstructure:"discovery_splash"`
	EmbeddedActivities          []any            `json:"embedded_activities" mapstructure:"embedded_activities"`
	Emojis                      []any            `json:"emojis" mapstructure:"emojis"`
	ExplicitContentFilter       int64            `json:"explicit_content_filter" mapstructure:"explicit_content_filter"`
	Features                    []any            `json:"features" mapstructure:"features"`
	GuildHashes                 GuildHashes      `json:"guild_hashes" mapstructure:"guild_hashes"`
	GuildScheduledEvents        []any            `json:"guild_scheduled_events" mapstructure:"guild_scheduled_events"`
	HubType                     any              `json:"hub_type" mapstructure:"hub_type"`
	...
	Presences                   []any            `json:"presences" mapstructure:"presences"`
	PublicUpdatesChannelID      any              `json:"public_updates_channel_id" mapstructure:"public_updates_channel_id"`
	Region                      string           `json:"region" mapstructure:"region"`
	Roles                       []Role           `json:"roles" mapstructure:"roles"`
	RulesChannelID              any              `json:"rules_channel_id" mapstructure:"rules_channel_id"`
	Splash                      any              `json:"splash" mapstructure:"splash"`
	StageInstances              []any            `json:"stage_instances" mapstructure:"stage_instances"`
	Stickers                    []any            `json:"stickers" mapstructure:"stickers"`
	...
	Threads                     []any            `json:"threads" mapstructure:"threads"`
	Unavailable                 bool             `json:"unavailable" mapstructure:"unavailable"`
	VanityURLCode               any              `json:"vanity_url_code" mapstructure:"vanity_url_code"`
